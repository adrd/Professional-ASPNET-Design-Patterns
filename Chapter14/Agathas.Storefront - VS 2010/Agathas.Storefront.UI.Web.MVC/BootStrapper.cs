    ...
    public class BootStrapper
    {
        ...
        public class ControllerRegistry : Registry
        {
            public ControllerRegistry()
            {
                ...
                ForRequestedType<IProductCatalogService>().TheDefault.Is.OfConcreteType<CachedProductCatalogService>()
                    .CtorDependency<IProductCatalogService>().Is(x => x.TheInstanceNamed("RealProductCatalogueService"));
