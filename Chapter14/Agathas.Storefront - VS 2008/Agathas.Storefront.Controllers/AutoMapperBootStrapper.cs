...
namespace Agathas.Storefront.Controllers
{
    public class AutoMapperBootStrapper
    {
        public static void ConfigureAutoMapper()
        {
            Mapper.CreateMap<OrderView, OrderPaymentRequest>()
                .ForMember(o => o.Total,
                           ov => ov.ResolveUsing<OrderTotalResolver>())
                .ForMember(o => o.ShippingCharge,
                           ov => ov.ResolveUsing<ShippingChargeResolver>());
    ...
    public class ShippingChargeResolver : ValueResolver<OrderView, decimal>
    {
        protected override decimal ResolveCore(OrderView source)
        {
            return decimal.Parse(source.ShippingCharge
                                  .Substring(1, source.ShippingCharge.Length - 1));
        }
    }
