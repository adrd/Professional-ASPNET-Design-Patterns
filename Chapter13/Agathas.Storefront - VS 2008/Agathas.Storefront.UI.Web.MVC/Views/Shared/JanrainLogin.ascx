...
<iframe src="http://aspnetdesignpatterns.rpxnow.com/openid/embed?token_url=<%=Server.UrlEncode(Html.Resolve("/" + Model.Controller +"/" + Model.Action + "/?returnUrl=" + Model.ReturnUrl))%>" 
